...
# 🔒 QATTIQ NAZORAT - ID bilan kirmaguncha HECH NARSA ko'rinmaydi
@app.before_request
def auth_gate():
    if request.path.startswith("/login") or request.path.startswith("/logout") or request.path == "/favicon.ico":
        return None
    tg_user = request.args.get('tg_user')
    if tg_user and tg_user.isdigit():
...
if __name__ == "__main__":
    ...
    print("="*50); print("🏪 SmartStore POS (QATTIQ NAZORAT)"); print("="*50)
