...
NAV_HTML = "<div class='nav'><div class='nav-brand'>🏪 SmartStore</div><div class='nav-links'><a href='/dashboard'>📊 Panel</a><a href='/pos'>🛒 Kassa</a><a href='/products'>📦 Mahsulot</a><a href='/sales'>🧾 Sotuvlar</a><a href='/debts'>💳 Qarzdor</a><a href='/reports'>📈 Hisobot</a><a href='/logout' onclick="try{localStorage.removeItem('ss_uid')}catch(e){}" style='color:var(--red);'>🚪 Chiqish</a></div></div>"
...
def index():
    ...
    # Agar session'da user bo'lmasa, login ga yo'naltirish
...
def login():
    ...
    return RP("""<div style="padding:24px;max-width:500px;margin:60px auto;"><div class="card" style="text-align:center;padding:40px;">
    <div style="font-size:64px;margin-bottom:20px;">🔐</div>
    <h1 style="font-size:32px;margin-bottom:12px;">SmartStore</h1>
    <p style="color:var(--dim);margin-bottom:32px;font-size:16px;">Telegram ID kiriting</p>
    <form method="POST">
    <input class="input" name="tg_id" placeholder="Masalan: 123456789" required style="font-size:20px;text-align:center;padding:20px;margin-bottom:16px;">
    <button class="btn btn-primary" style="width:100%;padding:18px;font-size:18px;">🚀 Kirish</button>
    </form>
    <p style="color:var(--dim);margin-top:24px;font-size:13px;">💡 ID ni bilish: Telegram'da @userinfobot ga yozing</p>
    </div></div>""")
